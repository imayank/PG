...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        gamma_vec = [self.gamma ** t for t in range(len(rewards))]
        list_of_discounted_returns = [np.dot(gamma_vec, rewards) for _ in rewards]
    ...
    def _discounted_cumsum(self, rewards):
        ...
        T = len(rewards)
        gamma_vec = [self.gamma ** t for t in range(T)]
        list_of_discounted_cumsums = [np.dot(rewards[t:], gamma_vec[:T-t]) for t in range(len(rewards))]
